      ...
      <h3 className="text-3xl font-bold text-center mb-8">Bienvenue à l'Église Pentecote Du Burundi</h3>
        <div className="container mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          ...
          <Link href="/news_details?id=1">
            ...
            <h3 className="text-2xl font-bold mb-2">Evenement Du 4/2/2023</h3>
            <button className="text-gray-700">Cliquez sur l'image pour voir la description de l'Evenement...</button>
          </Link>
        </div>
